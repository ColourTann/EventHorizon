...
public class Draw {
	...
	public static void drawTextureRotatedScaledCentered(SpriteBatch batch, Texture t, float x, float y, float xScale, float yScale, float radianRotation){
		batch.draw(t, x-t.getWidth()/2f*xScale, y-t.getHeight()/2f*yScale, t.getWidth()/2f*xScale, t.getHeight()/2f*yScale, t.getWidth(), t.getHeight(), xScale, yScale, rad2deg(radianRotation),0,0,t.getWidth(),t.getHeight(),false,true);
	}
