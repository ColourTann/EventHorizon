...
public final class PerleyBabes {  // Simplex noise in 2D, 3D and 4D

	private static PerleyBabes me;
	private static PerleyBabes get(){
		if(me==null)me=new PerleyBabes(5);
		return me;	
	}
	...
	public static float noise(float xin, float yin){
		return (float) get().noise((double)xin, (double)yin);
	}
	// 2D simplex noise
